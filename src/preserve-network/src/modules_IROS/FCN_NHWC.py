...
tf.flags.DEFINE_string("logs_dir", "/home/nvidia/catkin_ws/src/preserve-network/src/modules_IROS/", "path to logs directory")
...
tf.flags.DEFINE_string("weight", "15x15_50.npy","the latest weight saved")
...
def inference(image, keep_prob):
    ...
    with tf.variable_scope("inference"):
        ...
        if load_flag == False:
            ...
            conv1_1_w = utils.get_variable(weight_dict[("conv1_1_w")], name="conv1_1_w")
            conv1_1_b = utils.get_variable(weight_dict[("conv1_1_b")], name="conv1_1_b")
        ...
        if load_flag == False:
            ...
            conv1_2_w = utils.get_variable(weight_dict[("conv1_2_w")], name="conv1_2_w")
            conv1_2_b = utils.get_variable(weight_dict[("conv1_2_b")], name="conv1_2_b")
        ...
        if load_flag == False:
            ...
            conv2_1_w = utils.get_variable(weight_dict[("conv2_1_w")], name="conv2_1_w")
            conv2_1_b = utils.get_variable(weight_dict[("conv2_1_b")], name="conv2_1_b")
        ...
        if load_flag == False:
            ...
            conv2_2_w = utils.get_variable(weight_dict[("conv2_2_w")], name="conv2_2_w")
            conv2_2_b = utils.get_variable(weight_dict[("conv2_2_b")], name="conv2_2_b")
        ...
        if load_flag == False:
            ...
            conv3_1_w = utils.get_variable(weight_dict[("conv3_1_w")], name="conv3_1_w")
            conv3_1_b = utils.get_variable(weight_dict[("conv3_1_b")], name="conv3_1_b")
        ...
        if load_flag == False:
            ...
            conv3_2_w = utils.get_variable(weight_dict[("conv3_2_w")], name="conv3_2_w")
            conv3_2_b = utils.get_variable(weight_dict[("conv3_2_b")], name="conv3_2_b")
        ...
        if load_flag == False:
            ...
            conv3_3_w = utils.get_variable(weight_dict[("conv3_3_w")], name="conv3_3_w")
            conv3_3_b = utils.get_variable(weight_dict[("conv3_3_b")], name="conv3_3_b")
        ...
        if load_flag == False:
            ...
            conv3_4_w = utils.get_variable(weight_dict[("conv3_4_w")], name="conv3_4_w")
            conv3_4_b = utils.get_variable(weight_dict[("conv3_4_b")], name="conv3_4_b")
        ...
        if load_flag == False:
            ...
            conv4_1_w = utils.get_variable(weight_dict[("conv4_1_w")], name="conv4_1_w")
            conv4_1_b = utils.get_variable(weight_dict[("conv4_1_b")], name="conv4_1_b")
        ...
        if load_flag == False:
            ...
            conv4_2_w = utils.get_variable(weight_dict[("conv4_2_w")], name="conv4_2_w")
            conv4_2_b = utils.get_variable(weight_dict[("conv4_2_b")], name="conv4_2_b")
        ...
        if load_flag == False:
            ...
            conv4_3_w = utils.get_variable(weight_dict[("conv4_3_w")], name="conv4_3_w")
            conv4_3_b = utils.get_variable(weight_dict[("conv4_3_b")], name="conv4_3_b")
        ...
        if load_flag == False:
            ...
            conv4_4_w = utils.get_variable(weight_dict[("conv4_4_w")], name="conv4_4_w")
            conv4_4_b = utils.get_variable(weight_dict[("conv4_4_b")], name="conv4_4_b")
        ...
        if load_flag == False:
            ...
            conv5_1_w = utils.get_variable(weight_dict[("conv5_1_w")], name="conv5_1_w")
            conv5_1_b = utils.get_variable(weight_dict[("conv5_1_b")], name="conv5_1_b")
        ...
        if load_flag == False:
            ...
            conv5_2_w = utils.get_variable(weight_dict[("conv5_2_w")], name="conv5_2_w")
            conv5_2_b = utils.get_variable(weight_dict[("conv5_2_b")], name="conv5_2_b")
        ...
        if load_flag == False:
            ...
            conv5_3_w = utils.get_variable(weight_dict[("conv5_3_w")], name="conv5_3_w")
            conv5_3_b = utils.get_variable(weight_dict[("conv5_3_b")], name="conv5_3_b")
        ...
        if load_flag == False:
            ...
            conv5_4_w = utils.get_variable(weight_dict[("conv5_4_w")], name="conv5_4_w")
            conv5_4_b = utils.get_variable(weight_dict[("conv5_4_b")], name="conv5_4_b")
        ...
        if load_flag == False:
            ...
            W6 = utils.get_variable(weight_dict[("W6")], name="W6")
            b6 = utils.get_variable(weight_dict[("b6")], name="b6")
        ...
        if load_flag == False:
            ...
            W7 = utils.get_variable(weight_dict[("W7")], name="W7")
            b7 = utils.get_variable(weight_dict[("b7")], name="b7")
        ...
        if load_flag == False:
            ...
            W8 = utils.get_variable(weight_dict[("W8")], name="W8")
            b8 = utils.get_variable(weight_dict[("b8")], name="b8")
        ...
        if load_flag == False:
            ...
            W_t1 = utils.get_variable(weight_dict[("W_t1")], name="W_t1")
            b_t1 = utils.get_variable(weight_dict[("b_t1")], name="b_t1")
        ...
        if load_flag == False:
            ...
            W_t2 = utils.get_variable(weight_dict[("W_t2")], name="W_t2")
            b_t2 = utils.get_variable(weight_dict[("b_t2")], name="b_t2")
        ...
        if load_flag == False:
            ...
            W_t3 = utils.get_variable(weight_dict[("W_t3")], name="W_t3")
            b_t3 = utils.get_variable(weight_dict[("b_t3")], name="b_t3")
        conv_t3 = utils.conv2d_transpose_strided(fuse_2, W_t3, b_t3, output_shape=deconv_shape3, stride=8)

        prob_face_0, prob_face_1 = tf.split(tf.nn.softmax(conv_t3,dim=3), 2, 3)

    with tf.name_scope('Sliding'):
        kernel = tf.ones(shape=[15, 15, 1, 1], dtype=tf.float32)
        sliding_result = tf.nn.conv2d(prob_face_0, kernel, [1, 1, 1, 1], padding='SAME')
        sliding_result = tf.divide(sliding_result, tf.square(tf.cast(15, dtype=tf.float32)))
    ...
    graph_mask = confidence_level*tf.ones(shape=[shape[1], shape[2]],dtype=tf.float64)
    greater = tf.greater(tf.cast(sliding_result, dtype=tf.float64), graph_mask)

    g_bb_xy = tf.where(greater)
    g_bb_xy_left_upper = tf.subtract(g_bb_xy, tf.cast(tf.divide(15, 2), dtype=tf.int64))
    g_bb_xy_right_lower = tf.add(g_bb_xy, tf.cast(tf.divide(15, 2), dtype=tf.int64))
